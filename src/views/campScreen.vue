<template>
  <div class="content">
    ...
    <div class="content_bg" :style="{backgroundImage:`url(${require(`@/assets/images/${camp}.png`)})`}">
      ...
      <!--效果图-->
      <img :src="sensorDetail?require('@/assets/images/Group 27.png'):require('@/assets/images/Group 28.png')"
           v-show="sensorWindow" @click="changeDetail(0)"/>
      <img :src="gateDetail?require('@/assets/images/Group 29.png'):require('@/assets/images/Group 30.png')"
           v-show="gateWindow" @click="changeDetail(1)"/>
      <img :src="cameraDetail?require('@/assets/images/Group 31.png'):require('@/assets/images/Group 32.png')"
           v-show="cameraWindow" @click="changeDetail(2)"/>
      <img :src="sentryDetail?require('@/assets/images/Group 36.png'):require('@/assets/images/Group 35.png')"
           v-show="sentryWindow" @click="changeDetail(3)"/>
      <img :src="essentialDetail?require('@/assets/images/Group 33.png'):require('@/assets/images/Group 34.png')"
           v-show="essentialWindow" @click="changeDetail(4)"/>
    ...
    <div class="content_left" :class="[leftClose?'close':'']">
      <div class="left_comprehensive">
        ...
        <div class="left_comprehensive_body" :class="[topClose?'close':'']">
          <div class="left_comprehensive_content" :class="[topClose?'close':'']" @mouseenter="Stop()"
               @mouseleave="ScrollUp()" @scroll="paperScroll()">
            <div class="detail" v-for="(item,index) in comprehensiveLists" :style="{ top:comprehensiveTop }"
                 :key="index" @click="item.type==2?leftCarShow=true:''">
              <div>【<span :class="[item.type==0?'bjcolor':'',item.type==1?'jjcolor':'',item.type==2?'tjcolor':'',]">{{item.name}}</span>】
              </div>
              <div>{{item.time}}</div>
              <div>{{item.work}}</div>
            </div>
        ...
        <div class="left_comprehensive_checkbox" v-show="comprehensiveShow">
          <div :class="[comprehensiveStatus===0?'all':'']" style="cursor:pointer;" @mouseover="changeStatus('status',0)"
               @click="getStatus('all')">全部动态
          </div>
        ...
        <div :class="['left_comprehensive_checkbox2',comprehensiveStatus===1?'absolute2':'absolute3']"
             v-show="comprehensiveDetailShow">
          <div class="checkbox_content" v-show="comprehensiveStatus===1">
            <div :class="[comprehensiveDetailStatus===0?'select':'']" @mouseover="changeStatus('detail',0)"
                 @click="getStatus(0)">普通报警
            </div>
            <div :class="[comprehensiveDetailStatus===1?'select':'']" @mouseover="changeStatus('detail',1)"
                 @click="getStatus(1)">紧急报警
            </div>
            <div :class="[comprehensiveDetailStatus===2?'select':'']" @mouseover="changeStatus('detail',2)"
                 @click="getStatus(2)">特急报警
            </div>
          </div>
          <div class="checkbox_content" v-show="comprehensiveStatus===2">
            <div :class="[comprehensiveDetailStatus===3?'select':'']" @mouseover="changeStatus('detail',3)"
                 @click="getStatus(3)">人员出入
            </div>
            <div :class="[comprehensiveDetailStatus===4?'select':'']" @mouseover="changeStatus('detail',4)"
                 @click="getStatus(4)">车辆出入
            </div>
            <div :class="[comprehensiveDetailStatus===5?'select':'']" @mouseover="changeStatus('detail',5)"
                 @click="getStatus(5)">物资出入
            </div>
          </div>
        </div>
    ...
    <div class="content_bottom" :class="[bottomClose?'close':'']">
      <div class="bottom_checkbox">
        ...
        <div class="checkbox_one" @click="essentialShow=!essentialShow"><img :src="essentialShow?checkOK:checkCancel"/>要素
        </div>
      </div>
    ...
    .content_left {
      ...
      .left_comprehensive {
        ...
        .left_comprehensive_body {
          ...
          .left_comprehensive_content::-webkit-scrollbar {
            display: none
          }
        }
