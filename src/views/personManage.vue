<template>
  <div class="content" :class="[type?'bg1':'bg2']">
    <div class="btn_change" @click="type=false"></div>
    <div class="btn_change2" @click="type=true"></div>
...
<style lang="scss" scoped type="text/scss">
  .content {
    ...
    &.bg1 {
      background: url("../assets/images/personBg2.png") no-repeat;
    }
    &.bg2 {
